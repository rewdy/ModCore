...
// 	// make the post type
// 	register_post_type('genesys_resource', $args);
// }
...
add_action('widgets_init', 'genesys_widget_init');
...
function genesys_comment($comment, $args, $depth) {
...
add_filter('comment_form_defaults', 'genesys_comment_form');
